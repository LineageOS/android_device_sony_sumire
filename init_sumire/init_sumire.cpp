        ...
        const std::string& value, bool for_emulator __attribute__((unused))) 
{
	...
	//Dual Sim variant contains two IMEIs separated by comma.
        if ((count(value.begin(), value.end(),',')) > 0) { 
                ...
                property_set("ro.build.description", "sumire_dsds-user 6.0.1 KITAKAMI-2.1.2-SEC-161031-1748 1 dev-keys");
                property_set("ro.build.fingerprint", "Sony/sumire_dsds/sumire_dsds:6.0.1/KITAKAMI-2.1.2-SEC-161031-1748/1:user/dev-keys");
        } else {
                ...
                property_set("ro.build.description", "sumire-user 6.0.1 KITAKAMI-2.1.2-SEC-161031-1748 1 dev-keys");
                property_set("ro.build.fingerprint", "Sony/sumire/sumire:6.0.1/KITAKAMI-2.1.2-SEC-161031-1748/1:user/dev-keys");
        }
    }
}
