        ...
        const std::string& value, bool for_emulator __attribute__((unused)))
{
    ...
    if (key == "oemandroidboot.phoneid") {
        ...
        if ((count(value.begin(), value.end(),',')) > 0) {
            ...
            property_set("ro.build.description", "sumire_dsds-user 7.0 KITAKAMI-2.2.0-170123-1244 1 dev-keys");
            property_set("ro.build.fingerprint", "Sony/sumire_dsds/sumire_dsds:7.0/KITAKAMI-2.2.0-170123-1244/1:user/dev-keys");
        } else {
            ...
            property_set("ro.build.description", "sumire-user 7.0 KITAKAMI-2.2.0-170123-1244 1 dev-keys");
            property_set("ro.build.fingerprint", "Sony/sumire/sumire:7.0/KITAKAMI-2.2.0-170123-1244/1:user/dev-keys");
        }
    }
}
